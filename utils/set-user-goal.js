...
export async function setUserGoal(user) {
    ...
    // Macronutrient Needs
    const macronutrients = calculateMacronutrients(caloriesRequired, user);
  
    // Micronutrient RDAs Based on Age & Gender
    const micronutrients = calculateMicronutrients(user, age); 
  ...
  function calculateMacronutrients(caloriesRequired, user) {
    return {
      ...
      protein: user.weight * 1.6, // 1.6g per kg of body weight
    };
  }
  
  function calculateMicronutrients(user, age) {
    return {
      vit_a_rae: user.gender === "male" ? 900 : 700, // mcg
      vit_a: user.gender === "male" ? 3000 : 2330, // IU
      vit_c: user.gender === "male" ? 90 : 75, // mg
      vit_d: age >= 51 ? 20 : 15, // mcg
      vit_e: 15, // mg
      vit_k: user.gender === "male" ? 120 : 90, // mcg
      vit_b1: age >= 51 ? 1.2 : 1.1, // mg
      vit_b2: user.gender === "male" ? 1.3 : 1.1, // mg
      vit_b3: user.gender === "male" ? 16 : 14, // mg
      vit_b5: 5, // mg
      vit_b6: age >= 51 ? (user.gender === "male" ? 1.7 : 1.5) : 1.3, // mg
      vit_b9: 400, // mcg
      vit_b12: 2.4, // mcg
      choline: user.gender === "male" ? 550 : 425, // mg
      betaine: 1000, // mg (estimated)
      calcium: age >= 51 ? 1200 : 1000, // mg
      copper: 0.9, // mg
      fluoride: user.gender === "male" ? 4000 : 3000, // mcg
      iron: user.gender === "male" ? 8 : age < 51 ? 18 : 8, // mg
      magnesium: user.gender === "male" ? 420 : 320, // mg
      manganese: user.gender === "male" ? 2.3 : 1.8, // mg
      phosphorus: 700, // mg
      potassium: 3400, // mg
      selenium: 55, // mcg
      sodium: 2300, // mg
      zinc: user.gender === "male" ? 11 : 8, // mg
    };
  }
